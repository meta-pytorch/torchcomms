 ...
 *
 * Performance notes:
 * - Uses contiguous partition() to keep blocks for same peer adjacent
 * - Profiling shows this provides 39% better performance than interleaved
 *   partitioning for 1MB messages (30.40 vs 21.84 GB/s)
 * - Bottleneck is transport protocol overhead, not GPU-side scheduling
 *
 * Parameters:
 ...
 */
__device__ __forceinline__ void broadcastFlat(
    void* buff_d,
    int my_rank_id,
    int root_rank_id,
