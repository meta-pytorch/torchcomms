...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        TestParam{"Chunked_4KB_64lines", 4096, 1, 256, 64},
        TestParam{"Chunked_MultiStep_10", 4096, 1, 256, 64, 10},
        TestParam{"Chunked_64KB_64lines_MultiBlock", 65536, 4, 256, 64},
        TestParam{"Chunked_512t_64KB_64lines", 65536, 4, 512, 64},
        TestParam{"Chunked_256KB_64lines", 256 * 1024, 4, 256, 64},
        // Windowed mode with smaller buffers
        TestParam{"Windowed_4KB_32lines", 4096, 1, 256, 32},
        TestParam{"Windowed_64KB_128lines", 65536, 2, 256, 128}),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        TestParam{"4KB_Chunked_64lines", 4096, 1, 256, 64},
        TestParam{"4KB_Chunked_64lines_MultiStep_10", 4096, 1, 256, 64, 10},
        TestParam{"Chunked_MultiStep_MultiBlock", 65536, 4, 256, 64, 10}),
    [](const auto& info) { return info.param.name; });
