...
// `comms/pipes/P2pIbgdaTransportDevice.cuh` when `__HIP_PLATFORM_AMD__` is
...
// AMD verbs/nic headers are exported by //comms/pipes/amd:pipes_gda_device
// with header_namespace = "", so they are included without the
// `comms/pipes/amd/` prefix.
...
// =============================================================================
// doca_fence — wrapper from `comms/pipes/DocaVerbsUtils.cuh`
// =============================================================================
//
// On NVIDIA, this lives in `comms::pipes::doca_fence` (defined in
