...
// These tests verify put_group and put_signal_group partitioning and
// broadcast logic. Actual RDMA operations require a real DOCA QP, so
...
TEST_F(P2pIbgdaTransportDeviceTestFixture, PutSignalGroupBroadcast) {
  // Test that put_signal_group broadcasts the signal ticket from leader
  // to all lanes
  runAndVerify(
