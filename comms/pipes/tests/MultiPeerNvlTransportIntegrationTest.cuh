 ...
 * @param peerIndex The peer index to signal/wait from
 ...
 *
 * @param transport The MultiPeerDeviceTransport to use
 * @param peerIndex The destination peer index
 ...
 *
 * @param transport The MultiPeerDeviceTransport to use
 * @param peerIndex The source peer index
...
/**
 * Test kernel: Barrier with reset between phases
 *
 * Tests that barrier slot can be reused after calling reset_barrier().
 *
 * @param transport The MultiPeerDeviceTransport to use
 * @param barrierIdx The barrier slot index to use
 * @param doReset If true, reset the barrier after completion
 * @param result Output: 1 if successful
 */
 ...
 * all ranks. Both ranks must call barrier_peer() with each other's peer index.
 *
 * @param transport The MultiPeerDeviceTransport to use
 * @param peerIndex The peer index to synchronize with
 * @param barrierIdx The barrier slot index to use
 * @param result Output: 1 if successful
 */
