...
// Test write() - one-sided direct memory write to peer GPU
...
// Test barrier() - GPU-side pairwise barrier synchronization
// Signals peer and waits for peer to signal back
void testBarrier(
    P2pNvlTransportDevice p2p,
    int numBlocks,
    int blockSize,
