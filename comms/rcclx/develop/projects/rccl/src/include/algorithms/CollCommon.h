...
// The bf16 aliases live INSIDE this namespace on purpose. SET A
// (comms/common/algorithms/CollCommon.cuh) declares a global `using bf16 =
// hip_bfloat16`; this fork needs `__hip_bfloat16`. Keeping these at global
// scope would collide whenever both headers reach one translation unit.
#if defined(__HIP_PLATFORM_AMD__) || defined(__HIP_PLATFORM_HCC__)
