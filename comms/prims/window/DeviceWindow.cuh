...
class DeviceWindow {
 ...
 private:
  ...
  // HostWindow)
  friend struct comms::prims::test::NvlOnlyDeviceWindowBuffers;
  friend struct comms::prims::test::NvlOffsetPutDeviceWindowBuffers;
  friend struct comms::prims::test::IbgdaOnlyDeviceWindowBuffers;
};
