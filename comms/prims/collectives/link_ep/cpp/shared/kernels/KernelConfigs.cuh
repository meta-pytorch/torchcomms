...
// headers.
//
// NVSHMEM / rocshmem includes are intentionally omitted — prims'
// MultiPeerNvlTransport replaces NVSHMEM for NVLink signaling, and prims'
...
// don't use task_fifo (we use prims' barrier_sync instead), but the kernels
