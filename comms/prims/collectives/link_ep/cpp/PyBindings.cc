...
#include "comms/prims/collectives/link_ep/cpp/low_latency/Layout.h"
...
using namespace comms::prims::link_ep;

PYBIND11_MODULE(_cpp, m) {
  m.doc() =
      "Python bindings for comms.prims.collectives.link_ep MoE EP runtime";
