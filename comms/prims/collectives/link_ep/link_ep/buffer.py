...
"""
Python `Buffer` wrapper for the prims MoE expert-parallel runtime.

The C++ runtime backing `Buffer` lives in `comms.prims.collectives.link_ep._cpp`.
...
class Buffer:
    ...
    `comms/prims/collectives/link_ep/tests/`.
    """
    ...
    def __init__(
        ...
        if self.runtime.get_num_rdma_ranks() > 1 or low_latency_mode:
            ...
            # The prims IBGDA transport doesn't use NVSHMEM env vars; the
