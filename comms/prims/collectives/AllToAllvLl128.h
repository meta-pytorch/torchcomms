 ...
 *
 * This compatibility overload does not synthesize timeout state. New callers
 * that need abort or timeout behavior should pass an externally owned
 * `AbortDevice` with the overload below.
 *
 ...
 * @param timeout Ignored compatibility timeout.
