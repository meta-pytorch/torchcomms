...
// AllToAllvTile via `CompressorDispatch.cuh` (included below). The
...
// CompressorDispatch.cuh must follow SendRecvTile.cuh: its device-only section
...
#include "comms/prims/collectives/CompressorDispatch.cuh"

namespace comms::prims {

// `AnsCompressor`, `compressor_copyop`, and the compressed IBGDA
// send/recv dispatchers live in CompressorDispatch.cuh (included above),
