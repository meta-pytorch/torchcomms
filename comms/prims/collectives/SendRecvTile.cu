...
// compressed kernel symbols (`sendrecv_tile_compressed_kernel<NumWarps>`)
// and `fetch_and_reset_sendrecv_ans_compress_stats` live in the sibling
// SendRecvTileCompressed.cu translation unit.
