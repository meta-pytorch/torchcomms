...
Run with:
    buck2 test //comms/prims/collectives/triton/tests:test_device_alltoallv_dynamic
"""
...
class TestDeviceAlltoallvDynamicAPIAvailability(unittest.TestCase):
    ...
    def test_device_alltoallv_dynamic_importable(self) -> None:
        ...
        from comms.prims.collectives.triton import device_alltoallv_dynamic
    ...
    def test_compute_offsets_from_sizes_importable(self) -> None:
        ...
        from comms.prims.collectives.triton import compute_offsets_from_sizes
    ...
    def test_all_exports_present(self) -> None:
        ...
        from comms.prims.collectives import triton as collectives
    ...
    def test_module_docstring_present(self) -> None:
        ...
        from comms.prims.collectives.triton import device_alltoallv_dynamic as mod
...
class TestKernelStructure(unittest.TestCase):
    ...
    def test_non_pipelined_kernel_exists(self) -> None:
        ...
        from comms.prims.collectives.triton.device_alltoallv_dynamic import (
...
class TestSyncBufferAlltoallvOp(unittest.TestCase):
    ...
    def test_alltoallv_op_sync_buffer_parameter(self) -> None:
        ...
        from comms.prims.collectives.triton import AlltoallvOp
