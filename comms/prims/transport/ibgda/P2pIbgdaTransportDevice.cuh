...
// the shared stateless `IbSendRecvOps` (P2pIbTransportDeviceDecl.cuh);
// backend-owned `channelLayout_` carries the actual protocol state.
...
#pragma unroll 1
 ...
 public:
  ...
  __device__ __forceinline__ IbgdaSendRecvProgressStatus progress_send_once(
      ...
      const Timeout& timeout = Timeout(),
      Args... args) {
    return IbSendRecvOps{}.progress_send_once<P2pIbgdaTransportDevice, CopyOp>(
        *this,
        channelLayout_,
        group,
        src,
  ...
  __device__ __forceinline__ IbgdaSendRecvProgressStatus progress_recv_once(
      ...
      const Timeout& timeout = Timeout(),
      Args... args) {
    return IbSendRecvOps{}.progress_recv_once<P2pIbgdaTransportDevice, CopyOp>(
        *this,
        channelLayout_,
        group,
        dst,
  ...
  __device__ __forceinline__ void sendWithTrace(
    ...
    IbSendRecvOps{}.send<P2pIbgdaTransportDevice, CopyOp>(
        *this,
        channelLayout_,
        group,
        src,
  ...
  __device__ __forceinline__ void recvWithTrace(
    ...
    IbSendRecvOps{}.recv<P2pIbgdaTransportDevice, CopyOp>(
        *this,
        channelLayout_,
        group,
        dst,
