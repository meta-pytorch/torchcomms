...
void test_ll128_nvlink_send_recv(
    ...
    char* dst_d,
    size_t nbytes,
    comms::prims::Ll128Packet* ll128_buf,
...
void test_ll128_nvlink_forward(
    ...
    char* recv_dst_d,
    size_t nbytes,
    comms::prims::Ll128Packet* ll128_buf_a,
    comms::prims::Ll128Packet* ll128_buf_b,
    int num_blocks,
    int block_size,
...
void test_ll128_nvlink_bidirectional(
    ...
    char* dst1_d,
    size_t nbytes,
    comms::prims::Ll128Packet* ll128_buf_on_gpu0,
    comms::prims::Ll128Packet* ll128_buf_on_gpu1,
    int num_blocks,
    int block_size,
    size_t buffer_num_packets = 0,
    int num_steps = 1);
