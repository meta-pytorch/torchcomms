...
// @generated SignedSource<<44da41fb27c60e895f16c8284020978c8b574b05>>
...
int NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCKS_PER_GROUP_DEFAULTCVARVALUE;
int NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCK_GROUPS;
int NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCK_GROUPS_DEFAULTCVARVALUE;
...
int NCCL_CTRAN_ALLTOALLV_DEDUP_PREPARE_NUM_THREAD_BLOCK_GROUPS_DEFAULTCVARVALUE;
...
bool NCCL_CTRAN_ENABLE_TRACE_LOGGER_DEFAULTCVARVALUE;
...
int NCCL_CTRAN_NVL_SENDRECV_THREAD_BLOCK_SIZE_DEFAULTCVARVALUE;
...
std::string NCCL_CTRAN_TRACE_LOGGER_LOCAL_DIR_DEFAULTCVARVALUE;
...
static void readCvarEnv() {
  ...
  NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCKS_PER_GROUP_DEFAULTCVARVALUE =
      env2num<int>("NCCL_ENV_DO_NOT_SET", "1");

  if (NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCKS_PER_GROUP_DEFAULTCVARVALUE !=
      NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCKS_PER_GROUP) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCKS_PER_GROUP");
  ...
  NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCK_GROUPS_DEFAULTCVARVALUE =
      env2num<int>("NCCL_ENV_DO_NOT_SET", "1");

  if (NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCK_GROUPS_DEFAULTCVARVALUE !=
      NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCK_GROUPS) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_ALLTOALLV_DEDUP_FWD_NUM_THREAD_BLOCK_GROUPS");
  ...
  NCCL_CTRAN_ALLTOALLV_DEDUP_PREPARE_NUM_THREAD_BLOCK_GROUPS_DEFAULTCVARVALUE =
      env2num<int>("NCCL_ENV_DO_NOT_SET", "1");

  if (NCCL_CTRAN_ALLTOALLV_DEDUP_PREPARE_NUM_THREAD_BLOCK_GROUPS_DEFAULTCVARVALUE !=
      NCCL_CTRAN_ALLTOALLV_DEDUP_PREPARE_NUM_THREAD_BLOCK_GROUPS) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_ALLTOALLV_DEDUP_PREPARE_NUM_THREAD_BLOCK_GROUPS");
  ...
  NCCL_CTRAN_ENABLE_TRACE_LOGGER_DEFAULTCVARVALUE =
      env2bool("NCCL_ENV_DO_NOT_SET", "False");

  if (NCCL_CTRAN_ENABLE_TRACE_LOGGER_DEFAULTCVARVALUE !=
      NCCL_CTRAN_ENABLE_TRACE_LOGGER) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_ENABLE_TRACE_LOGGER");
  ...
  NCCL_CTRAN_NVL_SENDRECV_THREAD_BLOCK_SIZE_DEFAULTCVARVALUE =
      env2num<int>("NCCL_ENV_DO_NOT_SET", "-1");

  if (NCCL_CTRAN_NVL_SENDRECV_THREAD_BLOCK_SIZE_DEFAULTCVARVALUE !=
      NCCL_CTRAN_NVL_SENDRECV_THREAD_BLOCK_SIZE) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_NVL_SENDRECV_THREAD_BLOCK_SIZE");
  ...
  NCCL_CTRAN_REGISTER_DEFAULTCVARVALUE = NCCL_CTRAN_REGISTER::lazy;
  ...
  NCCL_CTRAN_TRACE_LOGGER_LOCAL_DIR_DEFAULTCVARVALUE =
      env2str("NCCL_ENV_DO_NOT_SET", "/tmp/");

  if (NCCL_CTRAN_TRACE_LOGGER_LOCAL_DIR_DEFAULTCVARVALUE !=
      NCCL_CTRAN_TRACE_LOGGER_LOCAL_DIR) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_TRACE_LOGGER_LOCAL_DIR");
