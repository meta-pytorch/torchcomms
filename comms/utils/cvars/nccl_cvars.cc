...
// @generated SignedSource<<2b4fdb1685e8c023b413393de4b2cde1>>
...
int MCCL_SCUBA_MAX_QUEUE_SIZE;
int MCCL_SCUBA_MAX_QUEUE_SIZE_DEFAULTCVARVALUE;
int MCCL_SCUBA_NUM_WORKERS;
int MCCL_SCUBA_NUM_WORKERS_DEFAULTCVARVALUE;
int MCCL_SCUBA_SAMPLE_RATE;
int MCCL_SCUBA_SAMPLE_RATE_DEFAULTCVARVALUE;
...
std::unordered_map<std::string, int*> env_int_values = {
    {"MCCL_SCUBA_MAX_QUEUE_SIZE", &MCCL_SCUBA_MAX_QUEUE_SIZE},
    {"MCCL_SCUBA_NUM_WORKERS", &MCCL_SCUBA_NUM_WORKERS},
    {"MCCL_SCUBA_SAMPLE_RATE", &MCCL_SCUBA_SAMPLE_RATE},
...
static void initEnvSet(std::unordered_set<std::string>& env) {
  ...
  env.insert("MCCL_SCUBA_MAX_QUEUE_SIZE");
  env.insert("MCCL_SCUBA_NUM_WORKERS");
  env.insert("MCCL_SCUBA_SAMPLE_RATE");
...
static void readCvarEnv() {
  ...
  MCCL_SCUBA_MAX_QUEUE_SIZE =
      env2num<int>("MCCL_SCUBA_MAX_QUEUE_SIZE", "10000");
  MCCL_SCUBA_MAX_QUEUE_SIZE_DEFAULTCVARVALUE =
      env2num<int>("NCCL_ENV_DO_NOT_SET", "10000");

  if (MCCL_SCUBA_MAX_QUEUE_SIZE_DEFAULTCVARVALUE != MCCL_SCUBA_MAX_QUEUE_SIZE) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override", "MCCL_SCUBA_MAX_QUEUE_SIZE");
  }
  MCCL_SCUBA_NUM_WORKERS = env2num<int>("MCCL_SCUBA_NUM_WORKERS", "8");
  MCCL_SCUBA_NUM_WORKERS_DEFAULTCVARVALUE =
      env2num<int>("NCCL_ENV_DO_NOT_SET", "8");

  if (MCCL_SCUBA_NUM_WORKERS_DEFAULTCVARVALUE != MCCL_SCUBA_NUM_WORKERS) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override", "MCCL_SCUBA_NUM_WORKERS");
  }
  MCCL_SCUBA_SAMPLE_RATE = env2num<int>("MCCL_SCUBA_SAMPLE_RATE", "100");
  MCCL_SCUBA_SAMPLE_RATE_DEFAULTCVARVALUE =
      env2num<int>("NCCL_ENV_DO_NOT_SET", "100");

  if (MCCL_SCUBA_SAMPLE_RATE_DEFAULTCVARVALUE != MCCL_SCUBA_SAMPLE_RATE) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override", "MCCL_SCUBA_SAMPLE_RATE");
  }
