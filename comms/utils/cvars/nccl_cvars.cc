...
// @generated SignedSource<<6641a75dc8b51f25f3e41c2e11d6d21d>>
...
bool NCCL_NET_WIDEN_LINKS;
bool NCCL_NET_WIDEN_LINKS_DEFAULTCVARVALUE;
...
std::unordered_map<std::string, bool*> env_bool_values = {
    ...
    {"NCCL_NET_WIDEN_LINKS", &NCCL_NET_WIDEN_LINKS},
...
static void initEnvSet(std::unordered_set<std::string>& env) {
  ...
  env.insert("NCCL_NET_WIDEN_LINKS");
...
static void readCvarEnv() {
  ...
  NCCL_NET_WIDEN_LINKS = env2bool("NCCL_NET_WIDEN_LINKS", "False");
  NCCL_NET_WIDEN_LINKS_DEFAULTCVARVALUE =
      env2bool("NCCL_ENV_DO_NOT_SET", "False");

  if (NCCL_NET_WIDEN_LINKS_DEFAULTCVARVALUE != NCCL_NET_WIDEN_LINKS) {
    CVAR_INFO("NCCL Config - CVAR {} has an override", "NCCL_NET_WIDEN_LINKS");
  }
