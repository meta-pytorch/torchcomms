...
int64_t NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE;
int64_t NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE_DEFAULTCVARVALUE;
...
uint64_t NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE;
uint64_t NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE_DEFAULTCVARVALUE;
uint64_t NCCL_CTRAN_IBGDA_MIN_RNR_TIMER;
uint64_t NCCL_CTRAN_IBGDA_MIN_RNR_TIMER_DEFAULTCVARVALUE;
uint64_t NCCL_CTRAN_IBGDA_QP_DEPTH;
uint64_t NCCL_CTRAN_IBGDA_QP_DEPTH_DEFAULTCVARVALUE;
uint64_t NCCL_CTRAN_IBGDA_RNR_RETRY;
uint64_t NCCL_CTRAN_IBGDA_RNR_RETRY_DEFAULTCVARVALUE;
uint64_t NCCL_CTRAN_IBGDA_SIGNAL_COUNT;
uint64_t NCCL_CTRAN_IBGDA_SIGNAL_COUNT_DEFAULTCVARVALUE;
...
bool NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET;
bool NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET_DEFAULTCVARVALUE;
...
uint64_t NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE;
uint64_t NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE_DEFAULTCVARVALUE;
...
bool NCCL_CTRAN_USE_PIPES;
bool NCCL_CTRAN_USE_PIPES_DEFAULTCVARVALUE;
...
std::unordered_map<std::string, int64_t*> env_int64_values = {
    ...
    {"NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE",
     &NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE},
...
std::unordered_map<std::string, bool*> env_bool_values = {
    ...
    {"NCCL_CTRAN_IB_EPOCH_LOCK_ENFORCE_CHECK",
     &NCCL_CTRAN_IB_EPOCH_LOCK_ENFORCE_CHECK},
    {"NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET",
     &NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET},
    ...
    {"NCCL_CTRAN_USE_PIPES", &NCCL_CTRAN_USE_PIPES},
...
static void initEnvSet(std::unordered_set<std::string>& env) {
  ...
  env.insert("NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE");
  ...
  env.insert("NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE");
  env.insert("NCCL_CTRAN_IBGDA_MIN_RNR_TIMER");
  env.insert("NCCL_CTRAN_IBGDA_QP_DEPTH");
  env.insert("NCCL_CTRAN_IBGDA_RNR_RETRY");
  env.insert("NCCL_CTRAN_IBGDA_SIGNAL_COUNT");
  ...
  env.insert("NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET");
  ...
  env.insert("NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE");
  ...
  env.insert("NCCL_CTRAN_USE_PIPES");
...
static void readCvarEnv() {
  ...
  NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE = env2num<int64_t>(
      "NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE", "4194304");
  NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE_DEFAULTCVARVALUE =
      env2num<int64_t>("NCCL_ENV_DO_NOT_SET", "4194304");

  if (NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE_DEFAULTCVARVALUE !=
      NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_ALLREDUCE_RING_BIDIR_AG_MAX_SIZE");
  ...
  NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE =
      env2num<uint64_t>("NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE", "0");
  NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE_DEFAULTCVARVALUE =
      env2num<uint64_t>("NCCL_ENV_DO_NOT_SET", "0");

  if (NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE_DEFAULTCVARVALUE !=
      NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_IBGDA_DATA_BUFFER_SIZE");
  }
  NCCL_CTRAN_IBGDA_MIN_RNR_TIMER =
      env2num<uint64_t>("NCCL_CTRAN_IBGDA_MIN_RNR_TIMER", "12");
  NCCL_CTRAN_IBGDA_MIN_RNR_TIMER_DEFAULTCVARVALUE =
      env2num<uint64_t>("NCCL_ENV_DO_NOT_SET", "12");

  if (NCCL_CTRAN_IBGDA_MIN_RNR_TIMER_DEFAULTCVARVALUE !=
      NCCL_CTRAN_IBGDA_MIN_RNR_TIMER) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_IBGDA_MIN_RNR_TIMER");
  }
  NCCL_CTRAN_IBGDA_QP_DEPTH =
      env2num<uint64_t>("NCCL_CTRAN_IBGDA_QP_DEPTH", "128");
  NCCL_CTRAN_IBGDA_QP_DEPTH_DEFAULTCVARVALUE =
      env2num<uint64_t>("NCCL_ENV_DO_NOT_SET", "128");

  if (NCCL_CTRAN_IBGDA_QP_DEPTH_DEFAULTCVARVALUE != NCCL_CTRAN_IBGDA_QP_DEPTH) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override", "NCCL_CTRAN_IBGDA_QP_DEPTH");
  }
  NCCL_CTRAN_IBGDA_RNR_RETRY =
      env2num<uint64_t>("NCCL_CTRAN_IBGDA_RNR_RETRY", "7");
  NCCL_CTRAN_IBGDA_RNR_RETRY_DEFAULTCVARVALUE =
      env2num<uint64_t>("NCCL_ENV_DO_NOT_SET", "7");

  if (NCCL_CTRAN_IBGDA_RNR_RETRY_DEFAULTCVARVALUE !=
      NCCL_CTRAN_IBGDA_RNR_RETRY) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override", "NCCL_CTRAN_IBGDA_RNR_RETRY");
  }
  NCCL_CTRAN_IBGDA_SIGNAL_COUNT =
      env2num<uint64_t>("NCCL_CTRAN_IBGDA_SIGNAL_COUNT", "1");
  NCCL_CTRAN_IBGDA_SIGNAL_COUNT_DEFAULTCVARVALUE =
      env2num<uint64_t>("NCCL_ENV_DO_NOT_SET", "1");

  if (NCCL_CTRAN_IBGDA_SIGNAL_COUNT_DEFAULTCVARVALUE !=
      NCCL_CTRAN_IBGDA_SIGNAL_COUNT) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_IBGDA_SIGNAL_COUNT");
  ...
  NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET =
      env2bool("NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET", "False");
  NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET_DEFAULTCVARVALUE =
      env2bool("NCCL_ENV_DO_NOT_SET", "False");

  if (NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET_DEFAULTCVARVALUE !=
      NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_IPC_REGCACHE_ENABLE_ASYNC_SOCKET");
  ...
  NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE =
      env2num<uint64_t>("NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE", "524288");
  NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE_DEFAULTCVARVALUE =
      env2num<uint64_t>("NCCL_ENV_DO_NOT_SET", "524288");

  if (NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE_DEFAULTCVARVALUE !=
      NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE) {
    CVAR_INFO(
        "NCCL Config - CVAR {} has an override",
        "NCCL_CTRAN_PIPES_NVL_CHUNK_SIZE");
  ...
  NCCL_CTRAN_USE_PIPES = env2bool("NCCL_CTRAN_USE_PIPES", "False");
  NCCL_CTRAN_USE_PIPES_DEFAULTCVARVALUE =
      env2bool("NCCL_ENV_DO_NOT_SET", "False");

  if (NCCL_CTRAN_USE_PIPES_DEFAULTCVARVALUE != NCCL_CTRAN_USE_PIPES) {
    CVAR_INFO("NCCL Config - CVAR {} has an override", "NCCL_CTRAN_USE_PIPES");
  }
