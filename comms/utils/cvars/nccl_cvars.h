...
extern bool NCCL_CTRAN_ENABLE_TRACE_LOGGER_DEFAULTCVARVALUE;
...
extern int NCCL_CTRAN_NVL_SENDRECV_THREAD_BLOCK_SIZE_DEFAULTCVARVALUE;
...
extern std::string NCCL_CTRAN_TRACE_LOGGER_LOCAL_DIR_DEFAULTCVARVALUE;
...
namespace ncclx {
constexpr std::array<std::string_view, 411> cvarNames = {
