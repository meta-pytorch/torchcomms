...
// @generated SignedSource<<bccf9c25cf2af73945f5f1e2136845cb>>
...
extern std::vector<std::string> NCCL_SOCKET_IFNAME;
extern std::vector<std::string> NCCL_SOCKET_IFNAME_DEFAULTCVARVALUE;
...
namespace ncclx {
constexpr std::array<std::string_view, 417> cvarNames = {
