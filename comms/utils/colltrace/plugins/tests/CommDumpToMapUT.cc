...
TEST_F(CommDumpToMapTest, IgnoresNullTerminalDiagnostic) {
  CollTraceDump dump;
  dump.terminalColls.push_back(TerminalCollRecord{});

  auto map = commDumpToMap(dump, {"CT_terminalColls"});

  EXPECT_EQ(map.at("CT_terminalColls"), "[]");
}
