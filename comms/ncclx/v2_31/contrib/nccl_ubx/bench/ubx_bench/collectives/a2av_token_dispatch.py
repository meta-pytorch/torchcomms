...
def bench_a2av_dispatch_ubx_bf16_topk(
    ...
    """
    from ubx import SymmAllocator
    from ubx.ops import compute_dispatch_topk_map, compute_token_offsets
...
def bench_a2av_dispatch_nccl_ep(
    ...
    if is_ll:
        ...
        _CUDA_RT.cudaMemcpyAsync(
            _tensor_data(nccl, topk_weights_t),
    ...
    local_p = (
        ctypes.cast(local_arr, ctypes.POINTER(ncclNDTensor_t)) if num_local else None
    )
