...
def nccl_gin_c_init(
    gin: _LLVMPtrType,
    backend_mask: cutlass.Int32,
    dev_comm: _LLVMPtrType,
    context_id: cutlass.Int32,
    resource_sharing_mode: cutlass.Uint8,
) -> None: ...
...
def nccl_lsa_barrier_session_init(
    session: _LLVMPtrType,
    coop: ncclCoopAny,
    dev_comm: _LLVMPtrType,
    team: ncclTeam,
    handle: ncclLsaBarrierHandle,
    index: cutlass.Uint32,
    multimem: cutlass.Boolean,
    mm_handle: ncclMultimemHandle,
) -> None: ...
...
def nccl_barrier_session_init(
    ...
    index: cutlass.Uint32,
    multimem: cutlass.Boolean,
    inner_mm_handle: ncclMultimemHandle,
) -> None: ...
