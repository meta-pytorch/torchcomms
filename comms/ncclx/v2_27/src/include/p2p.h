...
ncclResult_t ncclP2pAllocateShareableBuffer(size_t size, int directMap, ncclIpcDesc *ipcDesc, void **ptr, ncclComm* commm, const char* callsite);
...
// [META]: free/unmap sync buffers when destroying communicator
