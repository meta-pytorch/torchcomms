...
#define IBV_MQP_RETRY_ERRNO_ALL(e) (NCCL_IB_MQP_RETRY_ALL ? (e != 0) : IBV_MQP_RETRY_ERRNO(e))
...
ncclResult_t wrap_ibv_modify_qp(struct ibv_qp* qp, struct ibv_qp_attr* attr, int attr_mask) {
  ...
  int maxCnt = (int)NCCL_IB_MQP_RETRY_CNT + 1; // number of attempts = number of retry + 1
...
ncclResult_t wrap_ibv_is_fork_initialized(enum ibv_fork_status *ret) {
