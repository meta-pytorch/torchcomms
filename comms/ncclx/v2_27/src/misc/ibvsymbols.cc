...
ncclResult_t buildIbvSymbols(struct ncclIbvSymbols* ibvSymbols) {
  ...
  ASSIGN_SYM(ibvSymbols, ibv_is_fork_initialized, ibv_internal_is_fork_initialized);
...
#define LOAD_SYM_VERSION(handle, symbol, funcptr, version) do {  \
  ...
  LOAD_SYM_VERSION(ibvhandle, "ibv_is_fork_initialized", ibvSymbols->ibv_internal_is_fork_initialized, "IBVERBS_1.13");
