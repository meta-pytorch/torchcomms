...
#define RAS_KEEPALIVE_INTERVAL (1*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)
...
#define RAS_KEEPALIVE_TIMEOUT_WARN (5*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)
...
#define RAS_CONNECT_RETRY (1*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)
...
#define RAS_STUCK_TIMEOUT (20*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)

// Terminate ad-hoc connections that have not been used in 60 seconds.
#define RAS_IDLE_TIMEOUT (60*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)

// If the socket is closed by peer within 5 seconds from the idle timeout, do not attempt to re-establish.
#define RAS_IDLE_GRACE_PERIOD (5*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)

// Declare a peer as dead and don't retry communicating with it if we couldn't reach it for 60 seconds.
#define RAS_PEER_DEAD_TIMEOUT (60*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)
...
#define RAS_COLLECTIVE_LEG_TIMEOUT (RAS_COLLECTIVE_LEG_TIMEOUT_SEC*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)

// Abort a whole collective operation after at most RAS_COLLECTIVE_LEG_TIMEOUT+RAS_COLLECTIVE_EXTRA_TIMEOUT (10s).
#define RAS_COLLECTIVE_EXTRA_TIMEOUT (RAS_COLLECTIVE_EXTRA_TIMEOUT_SEC*CLOCK_UNITS_PER_SEC*NCCL_RAS_TIMEOUT_FACTOR)
