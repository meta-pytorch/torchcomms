...
Args:
  ...
  auto fr_submodule = m.def_submodule(
      "fr",
      "TorchComm Flight Recorder module for tracking collective operations");
  torch::comms::fr::initFlightRecorderPyBindings(fr_submodule);
}
