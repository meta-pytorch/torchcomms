...
void CachingAllocatorHookImpl::registerComm(TorchCommXCCL* comm) {
  std::lock_guard<std::mutex> lock(mutex_);
...
void CachingAllocatorHookImpl::deregisterComm(TorchCommXCCL* comm) {
  std::lock_guard<std::mutex> lock(mutex_);
...
bool CachingAllocatorHookImpl::isCommRegistered(TorchCommXCCL* comm) {
  std::lock_guard<std::mutex> lock(mutex_);
