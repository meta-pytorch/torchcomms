...
//
// The Window type is a typed device pointer (ctran::prims::DeviceWindow*)
...
//   - Window: ctran::prims::DeviceWindow* — typed device pointer to the
...
struct PipesDeviceBackend {
  ...
  using Window = ctran::prims::DeviceWindow*;
 ...
 private:
  ...
  static ctran::prims::MultiPeerDeviceHandle fetch_transport_handle(
      ncclComm_t nccl_comm,
      torch::comms::NcclxApi* nccl_api);
};
