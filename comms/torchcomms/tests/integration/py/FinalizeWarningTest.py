...
from torchcomms._internal import _create_prefixed_store
...
def create_store():
    ...
    maybe_set_rank_envs()
    return _create_prefixed_store("my_backend", "finalize_warning_test")
...
class FinalizeWarningTest(unittest.TestCase):
    ...
    def test_destructor_without_finalize_does_not_abort(self):
        ...
        store2 = _create_prefixed_store("my_backend", "finalize_warning_test_2")
        comm2 = new_comm(
            backend,
            device,
            store=store2,
