...
std::future<Status> MultiTransport::doTransfer(
  ...
  return (t->*op)(requests, std::move(options));
}

std::future<Status> MultiTransport::put(
    std::vector<TransferRequest> requests,
    RequestOptions options) {
  return doTransfer(requests, &Transport::put, std::move(options));
}

std::future<Status> MultiTransport::get(
    std::vector<TransferRequest> requests,
    RequestOptions options) {
  return doTransfer(requests, &Transport::get, std::move(options));
}
