...
// #define UNIFLOW_IBV_DIRECT 1
#ifndef UNIFLOW_IBV_DIRECT
#define UNIFLOW_IBV_DIRECT 0
#endif

#if UNIFLOW_IBV_DIRECT
#include <infiniband/verbs.h>
#else
// Dynamically handle dependencies on libibverbs.
// Copied from ncclx ibvcore.h (which mirrors infiniband/verbs.h) with
// function declarations and inline function definitions removed.
...
struct ibv_exp_dct; // forward declaration for ibv_async_event
...
struct ibv_xrc_domain; // forward declaration for backwards compat
...
struct verbs_context {
  ...
  struct ibv_flow* (
      *ibv_create_flow)(struct ibv_qp* qp, struct ibv_flow_attr* flow_attr);
