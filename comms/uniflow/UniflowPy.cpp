...
/// Build a RequestOptions from Python keyword arguments.
  ...
  py::class_<MultiTransport>(
      ...
      .def(
          ...
          [](MultiTransport& t, const py::bytes& info) {
            auto sv = static_cast<std::string_view>(info);
      ...
      .def(
          ...
          [](MultiTransport& t,
             ...
             std::optional<uintptr_t> stream,
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                t.put(std::move(reqs), makeRequestOptions(stream, timeoutMs)));
          },
      ...
      .def(
          ...
          [](MultiTransport& t,
             ...
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                t.get(std::move(reqs), makeRequestOptions(stream, timeoutMs)));
          },
      ...
      .def(
          ...
          [](MultiTransport& t,
             ...
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                t.send(src, makeRequestOptions(stream, timeoutMs)));
          },
      ...
      .def(
          ...
          [](MultiTransport& t,
             ...
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                t.recv(dst, makeRequestOptions(stream, timeoutMs)));
          },
  ...
  py::class_<MultiTransportFactory, std::shared_ptr<MultiTransportFactory>>(
      ...
      .def(
          ...
          [](MultiTransportFactory& f, const py::bytes& exportId) {
            auto sv = static_cast<std::string_view>(exportId);
            std::span<const uint8_t> span(
                reinterpret_cast<const uint8_t*>(sv.data()), sv.size());
            return toResult(f.importSegment(span));
          },
      ...
      .def(
          ...
          [](MultiTransportFactory& f, const py::bytes& peerTopology) {
            auto sv = static_cast<std::string_view>(peerTopology);
            std::span<const uint8_t> span(
                reinterpret_cast<const uint8_t*>(sv.data()), sv.size());
            return toResult(f.createTransport(span));
          },
  ...
  py::class_<Connection>(
      ...
      .def(
          ...
          [](Connection& c, const py::bytes& payload) {
            auto sv = static_cast<std::string_view>(payload);
            std::span<const uint8_t> span(
                reinterpret_cast<const uint8_t*>(sv.data()), sv.size());
            py::gil_scoped_release release;
      ...
      .def(
          ...
          [](Connection& c,
             ...
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                c.put(std::move(reqs), makeRequestOptions(stream, timeoutMs)));
          },
          "Initiate a batch put (write to remote).",
          py::arg("requests"),
          py::arg("stream") = py::none(),
      ...
      .def(
          ...
          [](Connection& c,
             ...
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                c.get(std::move(reqs), makeRequestOptions(stream, timeoutMs)));
          },
          "Initiate a batch get (read from remote).",
          py::arg("requests"),
          py::arg("stream") = py::none(),
      ...
      .def(
          ...
          [](Connection& c,
             ...
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                c.send(src, makeRequestOptions(stream, timeoutMs)));
          },
          "Send a registered segment span (zero-copy).",
          py::arg("src"),
          py::arg("stream") = py::none(),
      ...
      .def(
          ...
          [](Connection& c,
             ...
             std::optional<int> timeoutMs) {
            return UniflowFuture(
                c.recv(dst, makeRequestOptions(stream, timeoutMs)));
          },
          "Receive into a registered segment span (zero-copy).",
          py::arg("dst"),
          py::arg("stream") = py::none(),
