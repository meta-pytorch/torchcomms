...
#include "comms/ctran/prims/Tile.cuh"
...
using ctran::prims::MaxOp;
using ctran::prims::MinOp;
using ctran::prims::RegisterStorage;
using ctran::prims::SumOp;
using ctran::prims::Tile;
using ctran::prims::tile_accumulate;
using ctran::prims::tile_load;
using ctran::prims::tile_load_2d;
using ctran::prims::tile_load_accumulate;
using ctran::prims::tile_store;
using ctran::prims::tile_store_2d;
using ctran::prims::tile_zero;
