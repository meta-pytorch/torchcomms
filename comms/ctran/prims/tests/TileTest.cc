...
#include "comms/ctran/prims/tests/TileTest.cuh"
...
using ctran::prims::test::kTileTest2DCols;
using ctran::prims::test::kTileTest2DRows;
using ctran::prims::test::kTileTestBlockSize;
using ctran::prims::test::kTileTestTileElems;
using ctran::prims::test::test_tile_accumulate_max_float;
using ctran::prims::test::test_tile_accumulate_max_half;
using ctran::prims::test::test_tile_accumulate_min_bf16;
using ctran::prims::test::test_tile_accumulate_min_float;
using ctran::prims::test::test_tile_accumulate_sum_bf16;
using ctran::prims::test::test_tile_accumulate_sum_float;
using ctran::prims::test::test_tile_load_accumulate_sum_float;
using ctran::prims::test::test_tile_load_store_2d_float;
using ctran::prims::test::test_tile_load_store_bf16;
using ctran::prims::test::test_tile_load_store_float;
using ctran::prims::test::test_tile_load_store_half;
using ctran::prims::test::test_tile_partial_load_accumulate_max_float;
using ctran::prims::test::test_tile_partial_load_accumulate_min_float;
using ctran::prims::test::test_tile_partial_load_accumulate_sum_float;
using ctran::prims::test::test_tile_partial_load_float;
using ctran::prims::test::test_tile_partial_load_store_float;
using ctran::prims::test::test_tile_partial_load_tile_idx1_float;
using ctran::prims::test::test_tile_partial_store_float;
using ctran::prims::test::test_tile_zero_float;
