...
// `comms/ctran/prims` device headers.
...
// CUDA supports `__grid_constant__`; HIP does not. Keep the CUDA annotation for
// kernels that benefit from it and elide it for HIP builds.
#if defined(__HIP_PLATFORM_AMD__)
#define PIPES_GRID_CONSTANT
#else
#define PIPES_GRID_CONSTANT __grid_constant__
#endif
