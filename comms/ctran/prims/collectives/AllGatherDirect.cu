...
#include "comms/ctran/prims/collectives/AllGatherDirect.cuh"

#include "comms/common/AtomicUtils.cuh"
#include "comms/ctran/prims/CopyUtils.cuh"
#include "comms/ctran/prims/DeviceCheck.cuh"
...
#include "comms/ctran/prims/collectives/DirectCollectiveUtils.cuh"
...
template __global__ void direct_allgather_nvl_kernel<512>(
    const PIPES_GRID_CONSTANT DirectAllgatherNvlArgs,
    Timeout);

template __global__ void hierarchical_allgather_fused_kernel<512>(
    const PIPES_GRID_CONSTANT HierarchicalAllgatherFusedArgs,
    Timeout);

template __global__ void hierarchical_allgather_overlap_kernel<512>(
    const PIPES_GRID_CONSTANT HierarchicalAllgatherOverlapArgs,
    Timeout);
