...
Run with:
    buck2 test //comms/ctran/prims/collectives/triton/tests:test_device_alltoallv_dynamic
"""
...
def tearDownModule() -> None:
    """Release module-global CUDA tensors before Python process teardown."""
    mod = sys.modules.get(
    ...
    if mod is not None:
        completion_counters_cache = getattr(mod, "_COMPLETION_COUNTERS_CACHE", None)
        iteration_tensor_cache = getattr(mod, "_ITERATION_TENSOR_CACHE", None)
        if completion_counters_cache is not None:
            completion_counters_cache.clear()
        if iteration_tensor_cache is not None:
            iteration_tensor_cache.clear()
    if CUDA_AVAILABLE:
...
class TestDeviceAlltoallvDynamicAPIAvailability(unittest.TestCase):
    ...
    def test_device_alltoallv_dynamic_importable(self) -> None:
        ...
        from comms.ctran.prims.collectives.triton import device_alltoallv_dynamic
    ...
    def test_compute_offsets_from_sizes_importable(self) -> None:
        ...
        from comms.ctran.prims.collectives.triton import compute_offsets_from_sizes
    ...
    def test_all_exports_present(self) -> None:
        ...
        from comms.ctran.prims.collectives import triton as collectives
    ...
    def test_module_docstring_present(self) -> None:
        ...
        from comms.ctran.prims.collectives.triton import device_alltoallv_dynamic as mod
...
class TestSyncBufferAlltoallvOp(unittest.TestCase):
    ...
    def test_alltoallv_op_sync_buffer_parameter(self) -> None:
        ...
        from comms.ctran.prims.collectives.triton import AlltoallvOp
