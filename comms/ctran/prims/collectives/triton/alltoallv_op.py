...
class AlltoallvOp:
    ...
    * The iteration counter is auto-incremented after every collective call.
    ...
    def setup(self) -> None:
        ...
        from comms.ctran.prims.collectives.triton import prewarm_completion_counters
    ...
    def teardown(self) -> None:
        ...
        self.send_buf = None  # pyre-ignore[8]: Intentional cleanup
        self.recv_buf = None  # pyre-ignore[8]: Intentional cleanup
        self._local_recv_slot_offsets = None  # pyre-ignore[8]: Intentional cleanup
        self._send_sizes_bytes = None
        self._send_offsets_bytes = None
        self._recv_sizes_bytes = None
        self._total_tokens_buf = None  # pyre-ignore[8]: Intentional cleanup
        self._remote_write_offsets = None

        # Release MemPools AFTER buffers (buffers use the pools)
        self._send_pool = None  # pyre-ignore[8]: Intentional cleanup
        self._recv_pool = None  # pyre-ignore[8]: Intentional cleanup
