...
// `comms/ctran/prims/P2pIbgdaTransportDevice.cuh` when `__HIP_PLATFORM_AMD__`
// is defined, instead of the NVIDIA DOCA headers
...
// //comms/ctran/prims/amd:pipes_gda_device with header_namespace = "", so they
// are included without the `comms/ctran/prims/amd/` prefix.
...
// =============================================================================
// doca_fence — wrapper from `comms/ctran/prims/DocaVerbsUtils.cuh`
// =============================================================================
//
// On NVIDIA, this lives in `ctran::prims::doca_fence` (defined in
