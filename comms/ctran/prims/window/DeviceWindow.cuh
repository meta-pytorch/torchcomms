...
class DeviceWindow {
 ...
 private:
  ...
  // HostWindow)
  friend struct ctran::prims::test::NvlOnlyDeviceWindowBuffers;
  friend struct ctran::prims::test::NvlOffsetPutDeviceWindowBuffers;
  friend struct ctran::prims::test::IbgdaOnlyDeviceWindowBuffers;
};
