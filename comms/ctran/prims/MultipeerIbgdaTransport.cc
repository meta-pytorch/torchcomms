...
// by `comms/ctran/prims/amd/DocaCompat.h` (already included via
// `MultipeerIbgdaTransport.h`) which translates `doca_*` to the
// `pipes_gda_*` host APIs in `amd/pipes_gda/PipesGdaHost.{h,cc}`.
#ifndef __HIP_PLATFORM_AMD__
#include "comms/ctran/prims/CudaDriverLazy.h"
#include "comms/ctran/prims/DocaHostUtils.h"
#endif
#include "comms/ctran/prims/IbverbsLazy.h"
#include "comms/ctran/prims/MultipeerIbgdaDeviceTransport.cuh"
#include "comms/ctran/prims/MultipeerIbgdaTransportCuda.cuh"
#include "comms/ctran/prims/rdma/NicDiscovery.h"
...
void MultipeerIbgdaTransport::allocateResources() {
  ...
  // matches what `comms/ctran/prims/amd/MultipeerIbgdaTransportAmd.cu` does
