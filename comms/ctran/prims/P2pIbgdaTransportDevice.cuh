...
// `DocaVerbsUtils.cuh` wrapper that defines `ctran::prims::doca_fence`.
...
#include "comms/ctran/prims/amd/DocaCompat.h"
#else
#include <device/doca_gpunetio_dev_verbs_counter.cuh>
#include <device/doca_gpunetio_dev_verbs_onesided.cuh>

#include "comms/ctran/prims/DocaVerbsUtils.cuh"
#endif
#include "comms/ctran/prims/CopyOp.cuh"
...
// `PIPES_DEVICE_TRAP()` is defined in `comms/ctran/prims/DeviceMacros.cuh` and
// is intentionally available across all `comms/ctran/prims` device headers.
