...
struct PrepareConfig {
  int numSendIdxWorkers;
  int numIntraFwdIdxWorkers;
  int numFwdIxWorkers;
  int numRecvIdxWorkers;
  int numRecvOffsetWorkers;
  int numRecvRedIdxWorkers;
  int numResetSyncWorkers;
  int numThreads;
};
...
enum class PrepareRole {
  kPrepTmpSendIdx = 1 << 0,
  kPrepTmpIntraFwdIdx = 1 << 1,
  kPrepTmpFwdIdx = 1 << 2,
  kPrepTmpRecvIdx = 1 << 3,
  kPrepTmpRecvOffsets = 1 << 4,
  kPrepTmpRecvRedIdx = 1 << 5,
  kResetSync = 1 << 6,
  kPrepareAll = kPrepTmpSendIdx | kPrepTmpIntraFwdIdx | kPrepTmpFwdIdx |
      kPrepTmpRecvIdx | kPrepTmpRecvOffsets | kPrepTmpRecvRedIdx | kResetSync,
};
